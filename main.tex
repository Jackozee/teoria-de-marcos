...
\begin{itemize}
    ...
    \begin{align*}
        \eta_A: A & \to \mathcal{L}(A) \\
            a & \mapsto \down(a)
    \end{align*}
    %tal que $\mathcal{L}(f)(X)=\downarrow f[X]$, entonces basta probar que esta construcción de $\mathcal{L}(f)$ es functorial, que se deduce directa$\inf$-semiretículas
    %Para $A\overset{f}{\to}B\overset{g}{\to}C$, se cumple que:
    %\begin{align*}
    %    \mathcal{L}(f)(\bigcup\chi) & = \bigcup\{\mathcal{L}(f)(X)|X\in\chi\}\\
    %    \mathcal{L}(gf) & = \mathcal{L}(g)\mathcal{L}(f).
    %\end{align*}
    %Y en este caso, es de notar lo siguiente: Recordando el morfismo $A\overset{\eta}{\to}\mathcal{L}(A)$
    %de se miretículas inferiores, donde $A$ solo era una semiretícula, y de algún modo se 'completó' asignandole $\mathcal{L}(A)\in\Frm$, y $\eta_A$ cumple la propiedad que, si tenemos dos flechas $\left(f,g:\mathcal{L}(A)\to B\right)\in\Frm$, tales que $f\eta_A = g\eta_A$, entonces, para cualquier sección inferior $X\in\mathcal{L}(A)$, podemos ver a $X$ como sigue:
    %\begin{align*}
    %    X & = \bigcup\{\downarrow x\mid x\in X\} \\
    %      & = \bigcup\{\eta(x)\mid x\in X\}
    %      & = \bigcup\eta[X]
    %\end{align*}
    %por lo cuál
    %\begin{align*}
    ...
    %         & = \bigcup g\eta[X] = g(x)
    %\end{align*}
    %es decir, como $X$ es cualquiera, tenemos que $g=f$, y por ende $\eta_A$ es un epi-morfismo de marcos.
    ...
    \begin{center}
        \begin{tikzcd}
            ...
            & \mathcal{L}(A) \arrow[ld, "\bar{f} ", dashed] \\
            B
        \end{tikzcd}
    \end{center}
...
%\subsection*{SESIÓN 14: 28 OCT (parte 2)}
...
%\subsection*{SESIÓN 20: 23 NOV (Expo Armando 1)}
...
%\subsection*{SESIÓN 21: 25 NOV (Expo Armando 2, Yareli, Dante, Alfredo)}
...
%\subsection*{SESIÓN 22: 30 NOV (Expo Alfredo, dudas tarea)}
