...
El objetivo de este capítulo es introducir varias categorías y las
relaciones entre estas.

\section{Copos}
Sean $A,B$ dos conjuntos parcialmente ordenados
(copos, para abreviar).
Un morfismo de copos $f:A\to B$ es una función monótona (creciente).
...
un elemento $a\in A$ es una cota superior de $X$
...
\begin{defn}[Álgebra de Heyting]\label{defn:heyting}
...
ínfimos arbitrarios. Además, en general, los supremos finitos no
