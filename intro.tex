...
\begin{epigraphs}
\footnotesize\qitem{\emph{
In the wake of our existence, in our parades and in our dances. 
Touch, see and behold the wisdom of the party program, 
essential in our lifetime and irresistible in our touch. The great spirits proclaim 
that capitalism is indeed organised crime and we are all the victims.}}
...
\begin{epigraphs}
    \footnotesize\qitem{\emph{
    ¿Que hemos logrado hasta aquí, si es que se ha logrado algo?...}}
    ...
    \begin{epigraphs}
        \footnotesize\qitem{\emph{
        We will see this.. done properly}}
        {\emph{ 
        Harold Simmons}}
        \normalsize\end{epigraphs}
