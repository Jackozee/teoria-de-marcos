...
\begin{corollary}
  Dado un $\Sup$-morfismo $f\colon A\to B$, el núcleo de $f$
  es el operador cerradura $k\colon A\to A$ determinado por la condición
  \[
...
\begin{proof}
    ...
    \begin{itemize}
    \item[(1)] Sean $a,b\in A$ tales que $j(a)=j(b)$. Nótese que como $j\in NA$, entonces $a\leq j(a)$ y $b\leq j(b)$, por lo que a su vez $f(a)\leq f(j(a))$ y $f(b)\leq f(j(b))$. También, dado que $k\geq j$, se tiene que
    \begin{align*}
    ...
    \item[(2)] Para $j(a), j(b) \in A_j$ cualesquiera, 
    \begin{align*}
