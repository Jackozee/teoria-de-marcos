...
\begin{definition}[Conjuntos linealmente ordenados]
\leavevmode
\begin{itemize}
...
\end{proof}
\begin{definition}[Isomorfismo de conjuntos linealmente ordenados]
Un morfismo $f:A\to B$ entre conjuntos linealmente ordenados es una biyección monótona.
\end{definition}
\begin{definition}[Tipo de orden]
...
\end{definition}
\begin{example}[Construcción Von Neumann de $\mathbb{N}$]
...
\end{example}
\begin{example}[Algunos tipos de orden]
...
\end{definition}
\begin{definition}[Operaciones con conjuntos linealmente ordenados]
...
\begin{example}[Algunas propiedades de la suma de ordinales]
    \leavevmode
   \begin{itemize}
...
\end{example}
\begin{definition}[Producto y potencias de ordinales]
...
\begin{definition}[Encaje bien ordenado]
